// Soundboard playback via miniaudio (WASAPI) — same approach as SoundUX
// Plays soundboard audio to VB-Cable using miniaudio's WASAPI backend
// which supports multiple audio clients on the same endpoint
...
// Global state for VB-Cable playback
...
// Find VB-Cable playback device ID
